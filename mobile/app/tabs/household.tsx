...
const styles = StyleSheet.create({
  ...
  secondaryBtn: { minHeight: 54, backgroundColor: COLORS.surface, borderRadius: 15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.border }, secondaryBtnText: { color: COLORS.text, fontSize: 15, fontWeight: '600' },
  ...
  memberListItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.surface, borderRadius: 13, padding: 12, marginBottom: 8, gap: 11, borderWidth: 1, borderColor: COLORS.border }, memberRole: { fontSize: 11, color: COLORS.textMuted, textTransform: 'capitalize', marginTop: 2 }, memberBalance: { fontSize: 12, color: COLORS.textSecondary, fontWeight: '600' },
  actionBtn: { minHeight: 52, backgroundColor: COLORS.primary + '12', borderRadius: 14, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: COLORS.primary + '30' }, actionBtnText: { color: COLORS.primary, fontWeight: '700', fontSize: 14 }, secondaryActionBtn: { minHeight: 48, alignItems: 'center', justifyContent: 'center', marginTop: 6 }, secondaryActionText: { color: COLORS.textSecondary, fontSize: 13, fontWeight: '600' },
});

const modalStyles = StyleSheet.create({
  overlay: { flex: 1, backgroundColor: 'rgba(12,16,13,.44)', justifyContent: 'flex-end' }, sheet: { backgroundColor: COLORS.surface, borderTopLeftRadius: 26, borderTopRightRadius: 26, padding: 22, paddingBottom: 30, gap: 13 }, handle: { width: 38, height: 4, borderRadius: 2, backgroundColor: COLORS.border, alignSelf: 'center', marginBottom: 4 }, kicker: { fontSize: 9, fontWeight: '800', letterSpacing: 1.3, color: COLORS.primary }, title: { fontSize: 21, fontWeight: '800', color: COLORS.text }, subtitle: { fontSize: 13, lineHeight: 19, color: COLORS.textSecondary }, input: { backgroundColor: COLORS.background, borderRadius: 14, borderWidth: 1, borderColor: COLORS.border, paddingHorizontal: 16, height: 56, color: COLORS.text, fontSize: 16 }, button: { backgroundColor: COLORS.primary, borderRadius: 14, minHeight: 54, alignItems: 'center', justifyContent: 'center' }, buttonText: { color: '#fff', fontSize: 15, fontWeight: '700' }, cancel: { alignItems: 'center', padding: 10 }, cancelText: { color: COLORS.textSecondary, fontSize: 14, fontWeight: '600' }, qrCard: { alignItems: 'center', backgroundColor: '#fff', borderWidth: 1, borderColor: COLORS.border, borderRadius: 18, padding: 20, marginVertical: 4 }, code: { color: COLORS.text, fontWeight: '800', fontSize: 17, letterSpacing: 2.4, marginTop: 14 }, helper: { color: COLORS.textMuted, fontSize: 11, marginTop: 5, textAlign: 'center' },
});
